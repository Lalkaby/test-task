...
alter table order add constraint order_id_pk
    primary key(id);
...
CREATE INDEX IF NOT EXISTS order_username_idx on order(username);
CREATE INDEX IF NOT EXISTS order_order_time_idx on order(order_time);
CREATE INDEX IF NOT EXISTS order_phone_number_idx on order(phone_number);
------------------------------ INDEX order(username,order_time,phone_number) ------------------------------


------------------------------ INSERT order ------------------------------
INSERT INTO order (id_address,username,phone_number,user_email)
VALUES
...
INSERT INTO order (id_address,username,phone_number,user_email,order_time)
VALUES
